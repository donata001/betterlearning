...
urlpatterns = [
    ...
    url(r'^sorry', ComingSoon.as_view(), name='placeholder'),  
    ...
    url(r'^course_question_process/(?P<course>[0-9]+)/(?P<level>[0-9]+)/(?P<step>[0-9]+)/(?P<suuid>[0-9a-z]+)$', BeginCourse.as_view(), name='course_question_process'),
